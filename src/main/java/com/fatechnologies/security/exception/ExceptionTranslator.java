...
import com.fatechnologies.security.exception.utils.HeaderUtil;
import com.fatechnologies.security.exception.utils.RealConstants;
...
/**
 * SidebarController advice to translate the server side exceptions to client-friendly json structures.
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ProblemBuilder prepare(final Throwable throwable, final StatusType status, final URI type) {
        ...
        if (activeProfiles.contains(RealConstants.SPRING_PROFILE_PRODUCTION)) {
